const CACHE_NAME = 'cyber-security-training-v1';
const urlsToCache = [
    '/',
    '/index.html',
    '/styles.css',
...
self.addEventListener('push', event => {
    const options = {
        body: event.data ? event.data.text() : 'New training module available!',
    ...
    event.waitUntil(
        self.registration.showNotification('Cyber Security Training', options)
    );
});
